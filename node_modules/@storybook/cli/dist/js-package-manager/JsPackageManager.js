...
const logger = console; // Cannot be `import` as it's not under TS root dir
...
class JsPackageManager {
  ...
  retrievePackageJson() {
    ...
    return Object.assign(Object.assign({}, packageJson), {}, {
  ...
  addDependencies(options, dependencies) {
    ...
    if (skipInstall) {
      ...
      if (options.installAsDevDependencies) {
        packageJson.devDependencies = Object.assign(Object.assign({}, packageJson.devDependencies), dependenciesMap);
      } else {
        packageJson.dependencies = Object.assign(Object.assign({}, packageJson.dependencies), dependenciesMap);
      }
  ...
  addStorybookCommandInScripts(options) {
    ...
    const storybookCmd = (options === null || options === void 0 ? void 0 : options.staticFolder) ? `start-storybook -p ${sbPort} -s ${options.staticFolder}` : `start-storybook -p ${sbPort}`;
    const buildStorybookCmd = (options === null || options === void 0 ? void 0 : options.staticFolder) ? `build-storybook -s ${options.staticFolder}` : 'build-storybook';
  ...
  addScripts(scripts) {
    ...
    (0, _PackageJsonHelper.writePackageJson)(Object.assign(Object.assign({}, packageJson), {}, {
      scripts: Object.assign(Object.assign({}, packageJson.scripts), scripts)
    }));
  }
